...
wb_not_matching = pd.read_csv('Third Round CSV Results WB SELL TRF BUY/wb_third_round_not_match_wb_sell_trf_buy.csv', low_memory=False)
trf_not_matching = pd.read_csv('Third Round CSV Results WB SELL TRF BUY/trf_third_round_not_match_wb_sell_trf_buy.csv', low_memory=False)
