...
wb_not_matching = pd.read_csv('Fifth Round CSV Results WB SELL TRF BUY/wb_fifth_round_not_match_wb_sell_trf_buy.csv', low_memory=False)
trf_not_matching = pd.read_csv('Fifth Round CSV Results WB SELL TRF BUY/trf_fifth_round_not_match_wb_sell_trf_buy.csv', low_memory=False)
...
output_dir = 'Sixth Round CSV Results WB SELL TRF BUY'
os.makedirs(output_dir, exist_ok=True)
matching_wb_df.to_csv(os.path.join(output_dir, 'wb_sixth_round_match_wb_sell_trf_buy.csv'), index=False)
matching_trf_df.to_csv(os.path.join(output_dir, 'trf_sixth_round_match_wb_sell_trf_buy.csv'), index=False)
not_matching_wb_df.to_csv(os.path.join(output_dir, 'wb_sixth_round_not_match_wb_sell_trf_buy.csv'), index=False)
not_matching_trf_df.to_csv(os.path.join(output_dir, 'trf_sixth_round_not_match_wb_sell_trf_buy.csv'), index=False)
